                    ...
                    <tbody id="patientTableBody">
                        <?php foreach ($casualty_patients as $patient): ?>
                            <tr class="text-center patient-row" id="patient-row-<?php echo $patient['id']; ?>">
                                ...
                                <td><?php echo htmlspecialchars($patient['blood_group']); ?></td> <!-- NEW -->
                                ...
                                <td class="text-center">
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                            ...
                                            <li><a class="dropdown-item" href="view_patient.php?id=<?php echo urlencode($patient['id']); ?>"><i class="fa-regular fa-eye"></i> View Details</a></li>
                                            <li>
                                                <a class="dropdown-item delete-patient" href="delete_patient.php?id=<?php echo $patient['id']; ?>" data-id="<?php echo $patient['id']; ?>">
                                            ...
                                            <div>
                                                ...
                                                <?php else: ?>
                                                    <form method="post" action="process_ip_admission.php">
                                                        ...
                                                        <button type="submit" name="admit_to_ip" class="viwe_btns dropdown-item viwe_btns_admit">
                                                            <i class="fa-solid fa-bed"></i> Admit to IPD
                                                        </button>
                                                    </form>
                                                <?php endif; ?>
                                            </div>
